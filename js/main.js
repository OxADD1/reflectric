document.addEventListener('DOMContentLoaded', function() {
  ...
  const languages = {
    'de': {
      ...
      'features.pdf.title': 'PDF-Buch',
      'features.pdf.desc': 'Erstelle aus deinen Reflexionen ein zusammenhängendes PDF-Buch – ideal zum Archivieren oder Teilen.',
      'features.json.title': 'JSON Import/Export',
      'features.json.desc': 'Sichere zusätzliche Backups als JSON und importiere/exportiere deine Daten flexibel zwischen Geräten.',
